...
- [x] 1. Fix grid-styles.ts: header, actionHeaderCell, actionCellOdd opacity — aura-components-dev — remove backdrop-blur from header/actionHeaderCell, change partial-opacity backgrounds to fully opaque
