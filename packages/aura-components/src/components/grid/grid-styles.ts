export const GridStyles = {
    ...
    actionHeaderCell: 'flex-none sticky right-0 bg-surface-container-low/80 backdrop-blur-md border-l border-outline/10 dark:border-stone-50/10 z-20',
    actionHeaderCellGlass: 'bg-white/20 backdrop-blur-xl',
    ...
    actionCellGlass: 'bg-white/10 backdrop-blur-xl',
    ...
    groupRowGlass: 'bg-white/10 backdrop-blur-xl hover:bg-white/20',
    ...
    actionCell: 'flex-none flex items-center justify-center gap-1 sticky right-0 z-10 border-l border-outline/10 dark:border-stone-50/10 transition-colors duration-200 bg-surface-container-low/80 backdrop-blur-md',
