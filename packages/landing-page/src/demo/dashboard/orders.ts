import { GridBuilder, TabsBuilder, PanelBuilder, ChartBuilder, LabelBuilder } from 'aura-components';
import { of } from 'rxjs';
...
const ALL_ORDERS: Order[] = [
    { id: '#ORD-020', customer: 'Alice Johnson',   product: 'Pro Plan — Annual',      date: '2026-04-09', total: 1190.00, status: 'Processing' },
    { id: '#ORD-019', customer: 'Kevin Park',       product: 'Enterprise Add-on',      date: '2026-04-09', total:  299.00, status: 'Processing' },
    { id: '#ORD-018', customer: 'Rachel Kim',       product: 'Starter Plan — Monthly', date: '2026-04-08', total:   49.00, status: 'Shipped'    },
    { id: '#ORD-017', customer: 'Tara Nguyen',      product: 'Pro Plan — Monthly',     date: '2026-04-08', total:   99.00, status: 'Shipped'    },
    { id: '#ORD-016', customer: 'George Miller',    product: 'Data Export Module',     date: '2026-04-07', total:  149.00, status: 'Delivered'  },
    { id: '#ORD-015', customer: 'Laura Chen',       product: 'Pro Plan — Annual',      date: '2026-04-07', total: 1190.00, status: 'Delivered'  },
    { id: '#ORD-014', customer: 'Marcus Lee',       product: 'Starter Plan — Monthly', date: '2026-04-06', total:   49.00, status: 'Delivered'  },
    { id: '#ORD-013', customer: 'Oscar Ruiz',       product: 'API Access Pack',        date: '2026-04-06', total:  199.00, status: 'Delivered'  },
    { id: '#ORD-012', customer: 'Hannah Abbott',    product: 'Pro Plan — Annual',      date: '2026-04-05', total: 1190.00, status: 'Delivered'  },
    { id: '#ORD-011', customer: 'Priya Sharma',     product: 'Data Export Module',     date: '2026-04-05', total:  149.00, status: 'Delivered'  },
    { id: '#ORD-010', customer: 'Ethan Hunt',       product: 'Enterprise Plan',        date: '2026-04-04', total: 2490.00, status: 'Delivered'  },
    { id: '#ORD-009', customer: 'Diana Prince',     product: 'Pro Plan — Monthly',     date: '2026-04-04', total:   99.00, status: 'Cancelled'  },
    { id: '#ORD-008', customer: 'Charlie Brown',    product: 'API Access Pack',        date: '2026-04-03', total:  199.00, status: 'Delivered'  },
    { id: '#ORD-007', customer: 'Julia Roberts',    product: 'Starter Plan — Annual',  date: '2026-04-03', total:  490.00, status: 'Delivered'  },
    { id: '#ORD-006', customer: 'Ian Wright',       product: 'Pro Plan — Monthly',     date: '2026-04-02', total:   99.00, status: 'Cancelled'  },
    { id: '#ORD-005', customer: 'Fiona Gallagher',  product: 'Starter Plan — Monthly', date: '2026-04-02', total:   49.00, status: 'Delivered'  },
    { id: '#ORD-004', customer: 'Bob Smith',        product: 'Data Export Module',     date: '2026-04-01', total:  149.00, status: 'Delivered'  },
