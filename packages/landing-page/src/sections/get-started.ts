...
const USAGE_CODE = `import { ButtonBuilder, ButtonStyle } from 'aura-components';
import { of } from 'rxjs';

const btn = new ButtonBuilder()
  .withCaption(of('Hello, Aura!'))
...
function renderInstallCode(): string {
    return `<pre style="margin:0; color: rgba(255,255,255,0.85);"><code><span style="color: #a78bfa;">$</span> <span style="color: #34d399;">npm</span> <span style="color: #e2e8f0;">install</span> <span style="color: #93c5fd;">aura-components</span> <span style="color: #93c5fd;">rxjs</span>

<span style="color: rgba(255,255,255,0.3);"># or with yarn</span>
<span style="color: #a78bfa;">$</span> <span style="color: #34d399;">yarn</span> <span style="color: #e2e8f0;">add</span> <span style="color: #93c5fd;">aura-components</span> <span style="color: #93c5fd;">rxjs</span>

<span style="color: rgba(255,255,255,0.3);"># or with pnpm</span>
<span style="color: #a78bfa;">$</span> <span style="color: #34d399;">pnpm</span> <span style="color: #e2e8f0;">add</span> <span style="color: #93c5fd;">aura-components</span> <span style="color: #93c5fd;">rxjs</span></code></pre>`;
}

function renderUsageCode(): string {
    return `<pre style="margin:0; color: rgba(255,255,255,0.85);"><code><span style="color: #a78bfa;">import</span> <span style="color: #e2e8f0;">{</span> <span style="color: #93c5fd;">ButtonBuilder</span><span style="color: #e2e8f0;">,</span> <span style="color: #93c5fd;">ButtonStyle</span> <span style="color: #e2e8f0;">}</span> <span style="color: #a78bfa;">from</span> <span style="color: #fbbf24;">'aura-components'</span><span style="color: #e2e8f0;">;</span>
...
<span style="color: #a78bfa;">const</span> <span style="color: #34d399;">btn</span> <span style="color: #e2e8f0;">=</span> <span style="color: #a78bfa;">new</span> <span style="color: #93c5fd;">ButtonBuilder</span><span style="color: #e2e8f0;">()</span>
  <span style="color: #e2e8f0;">.</span><span style="color: #34d399;">withCaption</span><span style="color: #e2e8f0;">(</span><span style="color: #93c5fd;">of</span><span style="color: #e2e8f0;">(</span><span style="color: #fbbf24;">'Hello, Aura!'</span><span style="color: #e2e8f0;">))</span>
