...
The landing page is built as a standalone Vite-powered package within the `a1-components` monorepo. It leverages the same core technologies as the library itself: **Vanilla TypeScript**, **RxJS**, and **Tailwind CSS**.
...
The landing page fully integrates with the `aura-components` Theme Management system:
...
The landing page consumes `aura-components` directly as a workspace dependency. It showcases the library's:
